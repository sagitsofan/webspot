...
ctrlApp.directive('panelinput', function () {
    return {
        ...
        templateUrl: '/cms/directives/Text.html',
        scope : {
            model : "=ngModel",
            field : "="
        },
...
ctrlApp.directive('paneldropdown', function () {
    return {
        ...
        templateUrl: '/cms/directives/DropDown.html',
        scope : {
            model : "=ngModel",
            field : "="
        },
...
ctrlApp.directive('paneltextarea', function () {
    return {
        ...
        templateUrl: '/cms/directives/TextArea.html',
        scope : {
            model : "=ngModel",
            field : "="
        },
...
ctrlApp.directive('panelmultiple', function () {
    return {
        ...
        templateUrl: '/cms/directives/Multiple.html',
        scope : {
            model : "=ngModel",
            field : "="
        },
...
ctrlApp.directive('panelgrid', function () {
    return {
        ...
        templateUrl: '/cms/directives/Grid.html',
        scope : {
            model : "=ngModel",
            field : "="
        },
...
ctrlApp.directive('panelcheckbox', function () {
    return {
        ...
        templateUrl: '/cms/directives/Checkbox.html',
        scope : {
            model : "=ngModel",
            field : "="
        },
...
ctrlApp.directive('panelradiobutton', function () {
    return {
        ...
        templateUrl: '/cms/directives/Radiobutton.html',
        scope : {
            model : "=ngModel",
            field : "="
        },
...
ctrlApp.directive('panelcheckboxs', function () {
    return {
        ...
        templateUrl: '/cms/directives/CheckBoxs.html',
        scope : {
            model : "=ngModel",
            field : "="
        },
...
ctrlApp.directive('panelrtf', function () {
    return {
        ...
        templateUrl: '/cms/directives/Rtf.html',
        scope : {
            model : "=ngModel",
            field : "="
        },
...
ctrlApp.directive('paneldate', function () {
    return {
        ...
        templateUrl: '/cms/directives/Date.html',
        scope : {
            model : "=ngModel",
            field : "="
        },
...
ctrlApp.directive('panelgallery', function () {
    return {
        ...
        templateUrl: '/cms/directives/Gallery.html',
        scope : {
            model : "=ngModel",
            field : "="
        },
...
ctrlApp.directive('panelnumber', function () {
    return {
        ...
        templateUrl: '/cms/directives/Number.html',
        scope : {
            model : "=ngModel",
            field : "="
        },
...
ctrlApp.directive('panelphone', function () {
    return {
        restrict: 'E',
        controllerAs: 'PhoneCtrl',
        templateUrl: '/cms/directives/Phone.html',
        scope : {
            model : "=ngModel",
            field : "="
        },
...
ctrlApp.directive('panelurl', function () {
    return {
        ...
        templateUrl: '/cms/directives/Url.html',
        scope : {
            model : "=ngModel",
            field : "="
        },
...
ctrlApp.directive('panelrelationalgrid', function (GenericDataModel) {
    return {
        ...
        templateUrl: '/cms/directives/RelationalGrid.html',
        scope : {
            model : "=ngModel",
            field : "="
        },
